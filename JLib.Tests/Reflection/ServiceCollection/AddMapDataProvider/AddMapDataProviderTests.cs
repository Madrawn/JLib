        ...
        protected override IEnumerable<ReflectionTestOptions> Options { get; } = new ReflectionTestOptions[]
        {
            ...
            new(
                ...
                new []
                {
                    ...
                    $"    IDataProviderR       : {typeof(TestDataProvider<TestXrmEntity>).FullClassName()}",
                    $"    IDataProviderRw      : {typeof(TestDataProvider<TestXrmEntity>).FullClassName()}",
                    $"    ISourceDataProviderR : {typeof(TestDataProvider<TestXrmEntity>).FullClassName()}",
                    $"    ISourceDataProviderRw: {typeof(TestDataProvider<TestXrmEntity>).FullClassName()}",
                    $"  {nameof(TestCommandEntity)}",
                    $"    IDataProviderR       : {nameof(TestCeRepository)}",
                    $"    IDataProviderRw      : {nameof(TestCeRepository)}",
                    $"    ISourceDataProviderR : {typeof(WritableMapDataProvider<TestXrmEntity,TestCommandEntity>).FullClassName()}",
                    $"    ISourceDataProviderRw: {typeof(WritableMapDataProvider<TestXrmEntity,TestCommandEntity>).FullClassName()}",
                    $"  {nameof(TestGraphQlDataObject)}",
                    $"    IDataProviderR       : {nameof(TestGdoRepository)}",
                    $"    IDataProviderRw      : -",
                    $"    ISourceDataProviderR : {typeof(MapDataProvider<TestXrmEntity,TestGraphQlDataObject>).FullClassName()}",
